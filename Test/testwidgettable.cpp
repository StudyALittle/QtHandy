...
TestWidgetTable::TestWidgetTable()
{
    ...
    tableWidget->setHorizontalHeaderItems({
        ...
        new QhTableWidgetItem(tr("身份证号"), 220),
        new QhTableWidgetItem(tr("手机号"), 160),
        new QhTableWidgetItem(tr("性别"), 80),
        new QhTableWidgetItem(tr("地址"), 180, true),
    ...
    for (int n = 0; n < num; ++n) {
        ...
        tableWidget->setCellText(n, col++, "012345678912345678");
        tableWidget->setCellText(n, col++, "177xxxxxxxx");
